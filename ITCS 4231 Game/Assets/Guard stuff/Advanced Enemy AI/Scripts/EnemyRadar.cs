...
public class EnemyRadar : MonoBehaviour
{
	...
	private bool drawOverlapSphere; private bool playerSeen;
	//scripts
	private AIData info;
...
//									Debug.Log ("No can hear");
	...
	/// <param name="audibilityThreshold">Audibility threshold.</param>
	/// <param name="targetObject">Target object.</param>
	public static GameObject withinHearingRange(Transform transform, float audibilityThreshold, GameObject targetObject)
	{
		AudioSource[] colliderAudioSource;
		float audibility;
		if ((colliderAudioSource = targetObject.GetComponents <AudioSource>()) != null) {
...
//						Debug.Log ("No can hear");
	...
	{
		#if UNITY_EDITOR
		var mColor = UnityEditor.Handles.color;
		...
		UnityEditor.Handles.color = mColor;
		#endif
	}
	...
	public void drawHearngGizmo(){
		...
		UnityEditor.Handles.DrawWireDisc (transform.position, transform.up, hearingRadius);
		UnityEditor.Handles.color = mColor;
		#endif
	}
